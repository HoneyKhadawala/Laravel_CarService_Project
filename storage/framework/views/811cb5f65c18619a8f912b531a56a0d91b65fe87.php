                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php $__currentLoopData = $shoppackage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <form id="form1" enctype="multipart/form-data" method="post" action="/ShopPackage/update">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                <input type="hidden" name="id" value="<?php echo e($item->ShopPackage_Id); ?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="btn btn-secondary dropdown-toggle col-12 form-control" type="button" id="txtshopid data-toggle="dropdown" name="txtshopid" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <option <?php if($item->Shop_Id==$row->Shop_Id): ?> selected <?php endif; ?> value="<?php echo e($item->Shop_Id); ?>"><?php echo e($row->Shop_name); ?></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="btn btn-secondary dropdown-toggle col-12 form-control" type="button" id="txtpackageid" data-toggle="dropdown" name="txtpackageid" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <option <?php if($item->Package_Id==$row->Package_Id): ?> selected <?php endif; ?>  value="<?php echo e($row->Package_Id); ?>"><?php echo e($row->Package_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="txtstartdate" name="txtstartdate" value="<?php echo e($item->Start_Date); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtenddate">End_Date</label>
                                            <input type="date" class="form-control" id="txtenddate" name="txtenddate" value="<?php echo e($item->End_Date); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <input type="radio" id="paymode" name="paymode" value="cash" <?php if($item->PayMode=="cash"): ?> checked <?php endif; ?>>
                                            <label>Cash</label><br/>
                                            &nbsp;&nbsp;&nbsp;
                                             <input type="radio" id="paymode" name="paymode" value="Online" <?php if($item->PayMode=="Online"): ?> checked <?php endif; ?>>
                                            <label>Online</label>
                                        </div>
                                    </div>      
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <input type="radio" id="ispay" name="ispay" value="yes" <?php if($item->IsPay=="yes"): ?> checked <?php endif; ?>>
                                            <label>Yes</label><br/>
                                            &nbsp;&nbsp;&nbsp;
                                             <input type="radio" id="ispay" name="ispay" value="no" <?php if($item->IsPay=="no"): ?> checked <?php endif; ?>>
                                            <label>No</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txttranscationno" id="txttranscationno" value="<?php echo e($item->Transcation_number); ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">        
...
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Shop-Package/editshoppackage.blade.php ENDPATH**/ ?>