                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Add New Pending Shop</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="/Pending Shop/view">View All Pending Shop</a></li>
                                            <li class="breadcrumb-item active">Add new Pending Shop</li>
                                        </ol>
                                    </div>
...
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Pending-Shop/addpendingshop.blade.php ENDPATH**/ ?>