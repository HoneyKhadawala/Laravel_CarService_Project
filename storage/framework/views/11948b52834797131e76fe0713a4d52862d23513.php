                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($row->Request_Text); ?></td>
                                            <td><?php echo e($row->Plan_Id); ?></td>
                                            <td><?php echo e($row->Registration_Date); ?></td>
                                            <td>
                                                <button data-id="<?php echo e($row->Inqure_ID); ?>" data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Insurance_Inqure/viewinsuranceinqure.blade.php ENDPATH**/ ?>