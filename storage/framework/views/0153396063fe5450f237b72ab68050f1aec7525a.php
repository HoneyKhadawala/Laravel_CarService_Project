                ...
                <div class="clearfix">
                    <div id="masonry" class="row dlab-blog-grid-2">
                        <div class="post card-container col-lg-6 col-md-6 col-sm-6">
                            <?php $__currentLoopData = $viewshopdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="blog-post blog-grid ">
                                    <div class="dlab-post-media dlab-img-effect zoom-slow">
                                        <img src="<?php echo e(URL::asset('uploads/shop/photo')); ?>/<?php echo e($item->Shop_Image); ?>" alt="">
                                    </div>
                                    <div class="dlab-post-info text-justify">
                                        <div class="dlab-post-title ">
                                            <h3 class="post-title"><?php echo e($item->Shop_name); ?></h3>
                                        </div>
                                        <div>
                                            <span><b>Owner Name : </b><?php echo e($item->Shop_OwnerName); ?></span>
                                        </div>                                        
                                        <div>
                                            <span><b>Contact No. : </b> <?php echo e($item->Contact_No); ?></span>
                                        </div>
                                        <div>
                                            <span><b>Email : </b> <?php echo e($item->Email_Id); ?></span>
                                        </div>
                                        <div>
                                            <span><b>Address 1 : </b><?php echo e($item->Address); ?></span>
                                        </div>
                                        <div>
                                            <span> <b>Address 2 : </b><?php echo e($item->Address2); ?></span>
                                        </div>
                                        <div>
                                            <span><b value="<?php echo e($item->City_Id); ?>">City : </b> <?php echo e($item->City_name); ?> </span>
                                        </div>
                                        <div>
                                            <span><b>Landmark : </b> <?php echo e($item->landmark); ?></span>
                                        </div>
                                        <div>
                                            <span><b>Pincode : </b> <?php echo e($item->pincode); ?></span>
                                        </div> 
                                         <div>
                                            <span><b>About : </b> <?php echo e($item->About_Shop); ?></span>
                                        </div>                                        
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Front-Side.Master.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Front-Side/Shop-list/PortfolioShop.blade.php ENDPATH**/ ?>