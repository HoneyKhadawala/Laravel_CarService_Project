                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e($row->Model_Id); ?></td>
                                                    <td><?php echo e($row->Color); ?></td>
                                                    <td>
                                                        <img src="<?php echo e(URL::asset('uploads/Model-Color')); ?>/<?php echo e($row->Image1); ?>" width="100" height="100">
                                                    </td>
                                                    <td>
                                                        <img src="<?php echo e(URL::asset('uploads/Model-Color')); ?>/<?php echo e($row->Image2); ?>" width="100" height="100">
                                                    </td>
                                                    
                                                    <td>
                                                        <img src="<?php echo e(URL::asset('uploads/Model-Color')); ?>/<?php echo e($row->Image3); ?>" width="100" height="100">
                                                    </td>      
                                                    <td> 
                                                        <button type="button" class="btn btn-success waves-effect waves-light" style="margin: 2px;" onclick="window.location='/ModelColor/edit/<?php echo e($row->ModelColor_Id); ?>'">
                                                            <i class="mdi mdi-pencil d-block font-size-16"></i><!-- Edit -->
                                                        </button>
                                                        <button data-id="<?php echo e($row->ModelColor_Id); ?>" data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog" style="margin: 2px;">
...
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Model-Color/viewmodelcolor.blade.php ENDPATH**/ ?>