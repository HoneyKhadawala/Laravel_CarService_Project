                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php $__currentLoopData = $statedata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                                        <form action="/State/update" method="post" id="form1">
                                            <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                            <input type="hidden" name="id" value="<?php echo e($item->State_Id); ?>">
                                            
                                            <div class="form-group row mb-4">
                                                <label for="txtstatename" class="col-sm-3 col-form-label">State Name</label>
                                                <div class="col-sm-9">
                                                    <input type="text" value="<?php echo e($item->State_Name); ?>" class="form-control" name="txtstatename" id="txtstatename">
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/State/editstate.blade.php ENDPATH**/ ?>