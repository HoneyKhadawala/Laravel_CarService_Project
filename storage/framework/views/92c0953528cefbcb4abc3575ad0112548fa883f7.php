                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php $__currentLoopData = $getmodelcolor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <form id="form1" enctype="multipart/form-data" method="post" action="/ModelColor/update">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                <input type="hidden" name="id" value="<?php echo e($item->ModelColor_Id); ?>">
                                <input type="hidden" name="oldimg1" value="<?php echo e($item->Image1); ?>">
                                <input type="hidden" name="oldimg2" value="<?php echo e($item->Image2); ?>">
                                <input type="hidden" name="oldimg3" value="<?php echo e($item->Image3); ?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="txtselectmodelname" name="txtselectmodelname" class="btn btn-secondary dropdown-toggle col-12" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <?php $__currentLoopData = $getmodeldata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtmodelcolor" name="txtmodelcolor" value="<?php echo e($item->Color); ?>">
                                        </div>
                                    </div>
                                </div>                                
                                ...
                                <div class="row mb-4">
                                    <div class="col-4">
                                        ...
                                        <button type="button" class="btn btn-light waves-effect waves-light w-sm">
                                            ...
                                            <img src="<?php echo e(URL::asset('uploads/Model-Color')); ?>/<?php echo e($item->Image1); ?>" width="100" height="100">
                                        </button>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <button type="button" class="btn btn-light waves-effect waves-light w-sm">
                                            ...
                                            <img src="<?php echo e(URL::asset('uploads/Model-Color')); ?>/<?php echo e($item->Image2); ?>" width="100" height="100">
                                        </button>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <button type="button" class="btn btn-light waves-effect waves-light w-sm">
                                            ...
                                            <img src="<?php echo e(URL::asset('uploads/Model-Color')); ?>/<?php echo e($item->Image3); ?>" width="100" height="100">
                                        </button>
                                    </div>
                                </div>
...
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Model-Color/editmodelcolor.blade.php ENDPATH**/ ?>