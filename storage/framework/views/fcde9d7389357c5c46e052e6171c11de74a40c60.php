                ...
                <div class="clearfix">
                    <div id="masonry" class="row dlab-blog-grid-2">
                        <div class="post card-container col-lg-6 col-md-6 col-sm-6">
                            <?php $__currentLoopData = $displaycompanydata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="blog-post blog-grid ">
                                    <div class="dlab-post-info text-justify">
                                        <div class="dlab-post-title ">
                                            <h3 class="post-title"><?php echo e($item->InsuranceCmp_Name); ?></h3>
                                        </div>
                                        <div>
                                            <span><b>Description : </b><?php echo e($item->Description); ?></span>
                                        </div> 
                                        <div>
                                            <span><b>Email ID : </b><?php echo e($item->Email_id); ?></span>
                                        </div> 
                                        <div>
                                            <span><b>Contact No. : </b><?php echo e($item->Contact_No); ?></span>
                                        </div> 
                                        <div>
                                            <span><b>Office Address : </b><?php echo e($item->Off_Address); ?></span>
                                        </div>                                        
                                        <div>
                                            <span><b>Another Office Address : </b> <?php echo e($item->Off_Address2); ?></span>
                                        </div>    
                                        <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Front-Side.Master.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Front-Side/InsuranceCo/Detailcompany.blade.php ENDPATH**/ ?>