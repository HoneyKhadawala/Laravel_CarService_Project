                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/Service/update" method="post" id="fill-form">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                <input type="hidden" name="id" value="<?php echo e($item->Service_Id); ?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtservicename">Name</label>
                                            <input type="text" value="<?php echo e($item->Service_name); ?>" class="form-control" id="txtservicename" name="txtservicename">
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtservicetype">Type</label>
                                            <input type="text" value="<?php echo e($item->Service_type); ?>" class="form-control" id="txtservicetype" name="txtservicetype">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                     <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="txtservicedesc" name="txtservicedesc"><?php echo e($item->Service_description); ?></textarea>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Services/editservices.blade.php ENDPATH**/ ?>