                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 m-b30" name="id">
                        <div class="dlab-box">
                            <div class="dlab-media"> 
                                <a href="#"><img src="<?php echo e(URL::asset('uploads/shop/photo')); ?>/<?php echo e($row->Shop_Image); ?>" alt=""></a> 
                            </div>
                            <div class="dlab-info p-a30 border-1">
                                <h4 class="dlab-title m-t0"><a href="#"><?php echo e($row->Shop_name); ?></a></h4>
                                <p>Lorem ipsum dolor Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius  </p>
                                <a href="#" class="site-button"  onclick="window.location='/ShopPortfolio/<?php echo e($row->Shop_Id); ?>'">More</a>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Front-Side.Master.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Front-Side/Shop-list/viewshoplist.blade.php ENDPATH**/ ?>