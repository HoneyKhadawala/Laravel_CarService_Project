        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Add Price</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Add New Price</h4>
                            ...
                            <form action="/Prices/insert" method="post" id="fillform">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="txtonroadprice" class="form-control" id="txtonroadprice">
                                    </div>
                                </div>                                
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Price/addprice.blade.php ENDPATH**/ ?>