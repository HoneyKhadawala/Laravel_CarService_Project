                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <table class="table-bordered check-tbl">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('UserSide/assets/images/product/thumb3.jpg')); ?>" alt=""></td>
                                    <td>Prduct Item 3</td>
                                    <td>$28.00</td>
                                </tr>
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('UserSide/assets/images/product/thumb2.jpg')); ?>" alt=""></td>
                                    <td>Prduct Item 4</td>
                                    <td>$36.00</td>
                                </tr>
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('UserSide/assets/images/product/thumb1.jpg')); ?>" alt=""></td>
                                    <td>Prduct Item 5</td>
                                    <td>$28.00</td>
                                </tr>
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('UserSide/assets/images/product/thumb4.jpg')); ?>" alt=""></td>
                                    <td>Prduct Item 2</td>
                                    <td>$36.00</td>
                                </tr>
                                <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Front-Side.Master.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Front-Side/Checkout/viewcheckout.blade.php ENDPATH**/ ?>