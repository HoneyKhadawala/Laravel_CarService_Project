                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src= "<?php echo e(URL::asset('uploads/Model')); ?>/<?php echo e($row->Model_image); ?>" width="100" height="100"></td>
                                                        <td> 
                                                            <button type="button" class="btn btn-success waves-effect waves-light" onclick="window.location='/Model/edit/<?php echo e($row->Model_Id); ?>';">
                                                                <!-- <i class="mdi mdi-pencil d-block font-size-16 px-3"></i> -->Edit
                                                            </button>
                                                            <button data-id="<?php echo e($row->Model_Id); ?>"data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Model/viewmodel.blade.php ENDPATH**/ ?>