...
<?php $__env->startSection("main-section"); ?>
    ...
    <div class="page-content">
        ...
        <div class="section-full content-inner bg-white">
            ...
            <div class="container">
                <div class="row ">
                    <?php $__currentLoopData = $servicelistdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 col-sm-6 m-b30" name="id">
                        <div class="dlab-box">
                            ...
                            <div class="dlab-info p-a30 border-1">
                                <h4 class="dlab-title m-t0"><?php echo e($row->Service_name); ?></h4>
                                <p>Lorem ipsum dolor Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius  </p>
                                <a href="#" class="site-button"  onclick="window.location='/DetailServiceList/<?php echo e($row->Service_Id); ?>'">More</a> </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Front-Side.Master.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Front-Side/Services/ServiceList.blade.php ENDPATH**/ ?>