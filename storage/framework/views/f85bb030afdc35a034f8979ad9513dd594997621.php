                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Add New Model</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Add Model</h4>
                                        ...
                                        <form enctype="multipart/form-data" action="/Model/insert" method="post" id="fill-form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="txtmodelname" name="txtmodelname">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/Model/addmodel.blade.php ENDPATH**/ ?>