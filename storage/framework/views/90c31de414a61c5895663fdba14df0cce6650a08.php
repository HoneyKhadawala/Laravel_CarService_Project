                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php $__currentLoopData = $shopservice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <form id="fill-form" action="/ShopService/update" method="post">
                                            <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                            <input type="hidden" name="id" value="<?php echo e($item->ShopService_Id); ?>">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="btn btn-secondary dropdown-toggle col-12" type="button" data-toggle="dropdown" name="txtshopname" aria-haspopup="true" aria-expanded="false" id="txtshopname">
                                                            <?php $__currentLoopData = $shopdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                               <option <?php if($item->Shop_Id==$row->Shop_Id): ?> checked <?php endif; ?> value="<?php echo e($row->Shop_Id); ?>"><?php echo e($row->Shop_name); ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="btn btn-secondary dropdown-toggle col-12" type="button" data-toggle="dropdown" name="txtservicename" aria-haspopup="true" aria-expanded="false" id="txtservicename">
                                                            <?php $__currentLoopData = $servicedata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($row->Service_Id); ?>" <?php if($item->Service_Id==$row->Service_Id): ?> checked <?php endif; ?>><?php echo e($row->Service_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="txtprice" name="txtprice" value="<?php echo e($item->Price); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="txtcharge" name="txtcharge" value="<?php echo e($item->ExtraCharge); ?>">
                                                    </div>
                                                </div> 
                                            </div>  
                                            <div class="row">   
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="txtinfo" name="txtinfo" value="<?php echo e($item->ExtraInfo); ?>">
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/ShopService/editshopservice.blade.php ENDPATH**/ ?>