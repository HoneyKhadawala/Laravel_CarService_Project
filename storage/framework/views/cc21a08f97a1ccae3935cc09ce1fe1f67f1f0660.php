                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/City/update" method="post" id="fillform">
                                ...
                                <input type="hidden" name="id" value="<?php echo e($item->City_Id); ?>">
                                        ...
                                        <div class="dropdown">
                                            <select class="btn btn-secondary dropdown-toggle col-12" type="button" id="txtstate" data-toggle="dropdown" name="txtstate" aria-haspopup="true" aria-expanded="false">
                                              <?php $__currentLoopData = $statedata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <option <?php if($item->State_Id==$row->State_Id): ?>     selected <?php endif; ?> value="<?php echo e($row->State_Id); ?>"><?php echo e($row->State_Name); ?></option>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="<?php echo e($item->City_name); ?>" name="txtcityname" class="form-control" id="txtcityname">
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('MasterPage.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ProjectWork\CarProject\resources\views/City/editcity.blade.php ENDPATH**/ ?>