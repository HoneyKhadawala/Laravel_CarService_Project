...
<div class="page-wrapers">
    ...
    <div class="page-content dlab-login bg-secondry">
        <div class="top-head text-center logo-header">
            <a href="index-2.html">
                <img src="<?php echo e(URL::asset('UserSide/assets/images/logo.png')); ?>" alt=""/>
            </a>
        </div>
...
<?php /**PATH D:\ProjectWork\CarProject\resources\views/Front-Side/Login/login.blade.php ENDPATH**/ ?>