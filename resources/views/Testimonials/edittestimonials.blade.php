                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="/Testimonial/update" enctype="multipart/form-data" method="post" id="form1">
                                            ...
                                            <input type="hidden" name="id" value="{{ $item->Testimonial_Id }}">
                                            <input type="hidden" name="oldimg" value="{{ $item->Testimonial_Profile_Pic }}">
                                            
                                            <div class="form-group row mb-4">
                                                <div class="col-6">
                                                    <label for="txttestimonialname" class=" col-form-label">Testimonial Name</label><br/>
                                                    <input type="text" value="{{$item->Testimonial_name}}" class="form-control" name="txttestimonialname" id="txttestimonialname">
                                                </div>

                                                <div class="form-group mb-4 col-6">
                                                    <label for="txttestimonialnum" class=" col-form-label">Contact No.</label>
                                                    <input type="text" value="{{$item->Testimonial_Contact_No}}" class="form-control" name="txttestimonialnum" id="txttestimonialnum">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" value="{{$item->Designation}}" class="form-control" name="txttestimonialdesign" id="txttestimonialdesign">
                                                </div>

                                                <div class="form-group col-6 mb-4">
                                                    <label for="texttestimonial" class=" col-form-label">Testimonial Text</label>
                                                    <input type="text" value="{{$item->Testimonial_text}}" class="form-control" name="texttestimonial" id="texttestimonial">
                                            ...
                                            <div class="form-group row mb-4">
                                                <div class="col-6">
                                                    ...
                                                    <img src="{{URL::asset('uploads/Testimonial')}}\{{$item->Testimonial_Profile_Pic}}" height="100" width="100">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="testimonialisdisplay" class="testimonialisdisplay" value="yes" @if($item->IsDisplay=="yes") checked @endif >
                                                        <label>Yes</label><br/>
                                                        &nbsp;&nbsp;&nbsp;
                                                         <input type="radio" name="testimonialisdisplay" class="testimonialisdisplay" value="no" @if($item->IsDisplay=="no") checked @endif >
                                                        <label>No</label>
                                                    </div>
                                                </div>
                                            </div>  
