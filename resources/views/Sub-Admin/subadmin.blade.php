                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ URL::asset('uploads/Sub-Admin') }}\{{$row->Profile_pic}} " width="100" height="100"></td>
                                                        <td>{{$row->Name}}</td>
                                                        <td>{{$row->User_name}}</td>
                                                        <td>{{$row->Password}}</td>
                                                        ...
                                                        <td>{{$row->User_Type}}</td>
                                                        <td> 
                                                            <button type="button" class="btn btn-success waves-effect waves-light" style="margin: 2px;" onclick="window.location='/SubAdmin/edit/{{ $row->Admin_Id }}';">
                                                                <i class="mdi mdi-pencil d-block font-size-16"></i><!-- Edit -->
                                                            </button>
                                                            <button data-id="{{$row->Admin_Id}}"data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog" style="margin: 2px;">
