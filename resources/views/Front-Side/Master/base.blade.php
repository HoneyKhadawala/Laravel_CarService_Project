	        ...
	        <div class="sticky-header header-curve main-bar-wraper navbar-expand-lg">
	            <div class="main-bar bg-primary clearfix ">
	                <div class="container clearfix">
	                    <!-- website logo -->
	                    <div class="logo-header mostion"><a href="index-2.html"><img src="{{ URL::asset('UserSide/assets/images/logo.png') }}" width="193" height="89" alt=""></a></div>
	                    <!-- nav toggle button -->
	                        ...
	                        <ul class="nav navbar-nav nav-style">
	                            ...
	                            <li>
                                        ...
                                        @if(session("User_Profile"))
                                    		<img src="{{ URL::asset('UserUpload/MyProfile/')}}/{{ session('User_Profile')}}" alt="" class="round">
                                    	@else
                                    		<img src="{{ URL::asset('UserUpload/MyProfile/usericon.png') }}" alt="" class="round">
                                    	@endif
                                        {{session("User_name")}}<i class="fa fa-chevron-down"></i></a> 
	                ...
	                <div class="row">
	                    <div class="col-lg-4 col-md-4 col-sm-4 footer-col-4">
	                        <div class="widget widget_about">
	                            <div class="logo-footer"><img src="{{ URL::asset('UserSide/assets/images/logo.png') }}" alt=""></div>
