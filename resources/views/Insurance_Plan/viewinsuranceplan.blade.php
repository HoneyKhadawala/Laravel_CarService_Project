                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->InsurancePlan_Name}}</td>
                                            <td>{{$row->InsurancePlan_desc}}</td>
                                            <td>{{$row->InsurancePlan_price}}</td>
                                            <td>{{$row->InsurancePlan_Duration}}</td>
                                            <td>
                                                <img src="{{ URL::asset('uploads/InsurancePlan') }}\{{ $row->InsurancePlan_pdf_file }} " width="100" height="100">
                                            </td>
                                            <td>{{$row->InsurancePlan_Isactive}}</td>
                                            <td>
                                                <button type="bundletton" class="btn btn-success waves-effect waves-light" onclick="window.location='/InsuranceCompanyPlan/edit/{{$row->InsurancePlan_Id}}';">
                                                    <i class="mdi mdi-pencil d-block font-size-16 "></i><!-- Edit -->
                                                </button>
                                                <button data-id="{{$row->InsurancePlan_Id}}" data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog">
