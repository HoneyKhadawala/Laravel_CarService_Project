                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <button type="button" class="btn btn-success waves-effect waves-light" onclick="window.location='/State/edit/{{ $row->State_Id }}';">
                                                <!-- <i class="mdi mdi-pencil d-block font-size-16 px-3"></i> -->Edit
                                            </button>
                                            <button data-id="{{ $row->State_Id }}" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger waves-effect waves-light open-dialog">
