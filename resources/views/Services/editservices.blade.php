                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$item->Service_name}}" class="form-control" id="txtservicename" name="txtservicename">
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="txtservicetype">Type</label>
                                            <input type="text" value="{{$item->Service_type}}" class="form-control" id="txtservicetype" name="txtservicetype">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                     <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="txtservicedesc" name="txtservicedesc">{{$item->Service_description}}</textarea>
                                        </div>
                                    </div>
                                </div>
