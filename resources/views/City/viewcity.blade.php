                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $row->City_name }}</td>  
                                        <td> 
                                            <button type="button" class="btn btn-success waves-effect waves-light" onclick="window.location='/City/edit/{{ $row->City_Id }}';">
                                            <!-- <i class="mdi mdi-pencil d-block font-size-16 px-3"></i> -->Edit
                                            </button>
                                            <button data-id="{{ $row->City_Id }}" data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog">
