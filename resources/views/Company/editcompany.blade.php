                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form enctype="multipart/form-data" action="/Company/update" method="post" id="fill-form">
                                            ...
                                            <input type="hidden" name="id" value="{{ $item->Company_Id }}">
                                            <input type="hidden" name="oldimg" value="{{ $item->Company_logo }}">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="txtcompanyname">Company name</label>
                                                        <input type="text" class="form-control" id="txtcompanyname" name="txtcompanyname" value=" {{ $item->Company_name }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-12">
                                                    ...
                                                    <img src="{{ URL::asset('uploads/company') }}/{{ $item->Company_logo }}" width="100" height="100"/>
                                                </div>
