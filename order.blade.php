@extends('Admin-Side.MasterPage.base')
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$row['PickAddress1']}}</td>
                                                    <td>{{$row['PickAddress2']}}</td>
                                                    <td>{{$row['Landmark']}}</td>
                                                    <td>{{$row['Pincode']}}</td>
                                                    <td>{{$row['City_Id']}}</td>
                                                    <td>{{$row['Latitude']}}</td>
                                                    ...
                                                    <td>{{$row['OrderDate']}}</td>
                                                    <td>
                                                        <button data-id="{{ $row->Order_Id }}" data-toggle="modal" type="button" data-target="#myModal" class="btn btn-danger waves-effect waves-light open-dialog" style="margin: 2px;">
